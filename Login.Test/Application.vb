...
<TestClass()> Public Class Application
    ...
    <TestMethod()> Public Sub RegisterAndLoginMethod()
        Dim a As New Login.Application.Services.LoginServiceUnOfficialEntity
    ...
    Public Function Register(a As Login.Application.Services.LoginServiceUnOfficialEntity, Username As String, Password As String) As FoundationLibrary.ValMsg.ValMsg(Of Login.Core.Entity.Entity)
    ...
    End Function
    Public Function Login(a As Login.Application.Services.LoginServiceUnOfficialEntity, Username As String, Password As String) As FoundationLibrary.ValMsg.ValMsg(Of Login.Core.Entity.Entity)
