...
<TestClass()> Public Class Application
    ...
    Public Function Register(a As Login.Application.Services.LoginService, Username As String, Password As String) As FoundationLibrary.ValMsg.ValMsg(Of Login.Core.Entity.Entity)
    ...
    End Function
    Public Function Login(a As Login.Application.Services.LoginService, Username As String, Password As String) As FoundationLibrary.ValMsg.ValMsg(Of Login.Core.Entity.Entity)
